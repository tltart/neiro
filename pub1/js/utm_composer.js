...
function make_url() {
    ...
    $(".utm_value").each(function (i) {
        var o = $(this).val().trim();
        if (0 === i) {
            if ("" === o) url = "http://yourdomain.com/?"; else {
                var r = o.split("#");
                r.length > 1 && (o = r[0], n = r[1]), o = ((o = "http" == o.substring(0, 4) ? o : "http://" + o).match(/\//g) || []).length > 2 ? o : o + "/", url = o.indexOf("?") < 0 ? o + "?" : "?" == o.slice(-1) ? o : "&" != o.slice(-1) ? o + "&" : o
            }
            t.push(url)
        } else if ("" !== o) {
...
var ready, sources_data = {
    direct: {
        source: {value: "yandex", info: ""},
        medium: {value: "cpc", info: ""},
        campaign: {
            value: "{campaign_id}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {campaign_id} \u042f\u043d\u0434\u0435\u043a\u0441.\u0414\u0438\u0440\u0435\u043a\u0442 \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 ID \u043a\u0430\u043c\u043f\u0430\u043d\u0438\u0438"
        },
        content: {
            value: "{ad_id}_{source}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {ad_id} \u042f\u043d\u0434\u0435\u043a\u0441.\u0414\u0438\u0440\u0435\u043a\u0442 \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 ID \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f, \u0430 {source} \u0437\u0430\u043c\u0435\u043d\u0438\u0442 \u043d\u0430 \u0434\u043e\u043c\u0435\u043d \u043f\u043b\u043e\u0449\u0430\u0434\u043a\u0438 \u043f\u0440\u0438 \u043f\u043e\u043a\u0430\u0437\u0435 \u043d\u0430 \u0441\u0430\u0439\u0442\u0435 \u0420\u0421\u042f;\nnone \u2014 \u043f\u0440\u0438 \u043f\u043e\u043a\u0430\u0437\u0435 \u043d\u0430 \u043f\u043e\u0438\u0441\u043a\u0435 \u042f\u043d\u0434\u0435\u043a\u0441\u0430"
        },
        term: {
            value: "{keyword}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {keyword} \u042f\u043d\u0434\u0435\u043a\u0441.\u0414\u0438\u0440\u0435\u043a\u0442 \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 \u043a\u043b\u044e\u0447\u0435\u0432\u043e\u0435 \u0441\u043b\u043e\u0432\u043e"
        }
    },
    adwords: {
        source: {value: "google", info: ""},
        medium: {value: "cpc", info: ""},
        campaign: {
            value: "{network}",
            info: '\u0412\u043c\u0435\u0441\u0442\u043e {network} \u0441\u0438\u0441\u0442\u0435\u043c\u0430 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 "g" (\u043f\u043e\u0438\u0441\u043a google), "s" (\u043f\u043e\u0438\u0441\u043a\u043e\u0432\u044b\u0439 \u043f\u0430\u0440\u0442\u043d\u0435\u0440) \u0438\u043b\u0438 "d" (\u041a\u041c\u0421)'
        },
        content: {
            value: "{creative}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {creative} AdWords \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 ID \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f"
        },
        term: {
            value: "{keyword}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {keyword} AdWords \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u043a\u043b\u044e\u0447\u0435\u0432\u043e\u0435 \u0441\u043b\u043e\u0432\u043e"
        }
    },
    targetmail: {
        source: {value: "targetmail", info: ""},
        medium: {value: "cpc", info: ""},
        campaign: {
            value: "{{campaign_id}}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {{campaign_id}} \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442\u0441\u044f ID \u043a\u0430\u043c\u043f\u0430\u043d\u0438\u0438"
        },
        content: {
            value: "{{banner_id}}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {{banner_id}} \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442\u0441\u044f ID \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f"
        },
        term: {
            value: "{{geo}}.{{gender}}.{{age}}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {{geo}}.{{gender}}.{{age}} \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442\u0441\u044f ID \u0440\u0435\u0433\u0438\u043e\u043d\u0430, \u043f\u043e\u043b \u0438 \u0432\u043e\u0437\u0440\u0430\u0441\u0442 \u043a\u043b\u0438\u043a\u043d\u0443\u0432\u0448\u0435\u0433\u043e \u043f\u043e \u0440\u0435\u043a\u043b\u0430\u043c\u0435"
        }
    },
    vk: {
        source: {value: "vk", info: ""},
        medium: {value: "cpc", info: ""},
        campaign: {
            value: "{campaign_id}",
            info: "VK \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u0437\u0430\u043c\u0435\u043d\u0438\u0442 {campaign_id} \u043d\u0430 ID \u0440\u0435\u043a\u043b\u0430\u043c\u043d\u043e\u0439 \u043a\u0430\u043c\u043f\u0430\u043d\u0438\u0438"
        },
        content: {
            value: "{ad_id}",
            info: "VK \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u0437\u0430\u043c\u0435\u043d\u0438\u0442 {ad_id} \u043d\u0430 ID \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f"
        },
        term: {value: "", info: ""}
    },
    "default": {
    ...
    fb: {
        source: {value: "facebook", info: ""},
        medium: {value: "cpc", info: ""},
        campaign: {
            value: "{campaign.name}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {campaign.name} Facebook \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 \u0438\u043c\u044f \u043a\u0430\u043c\u043f\u0430\u043d\u0438\u0438"
        },
        content: {
            value: "{ad.name}",
            info: "\u0412\u043c\u0435\u0441\u0442\u043e {ad.name} Facebook \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043f\u043e\u0434\u0441\u0442\u0430\u0432\u0438\u0442 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043e\u0431\u044a\u044f\u0432\u043b\u0435\u043d\u0438\u044f"
        },
        term: {value: "", info: ""}
    },
    instagram: {
        source: {value: "instagram", info: ""},
        medium: {value: "cpc", info: ""},
        campaign: {value: "", info: ""},
        content: {value: "", info: ""},
        term: {value: "", info: ""}
...
ready = function () {
    new Clipboard($(".copy")[0]).on("success", function () {
        ...
        $("#copy").text("\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c").attr("data-clipboard-text", "")
    }), $("input[type=radio][name=adv_traffic]").change(function () {
        clear_fields();
        var e = sources_data[$(this).data("type")];
        $.each(e, function (e, t) {
            $("#" + e).val(t.value);
