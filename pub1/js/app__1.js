...
document.addEventListener('DOMContentLoaded', function () {
	...
	$(document).on('click', '.sidebar-secondary-hide', function (e) {
		...
		if (typeof $(this).attr('href') === "undefined") {
			...
			if ($('.sidebar-secondary').is(':visible')) {
				$('.display-all-content').css('display', 'none');
				data = $(this).attr('data-settings');
	...
	$(document).on('click', '.display-all-content.colltrecing a', function (e) {
		href = $(this).attr('data-type-menu');
		$('.display-all-content.colltrecing li').removeClass('active');
...
$(document).on('click', '.get_more_page_project', function () {
	project_id = $(this).data('id');
	page = $(this).data('page');
	get_project_table_right(project_id, page)
...
function get_project_table_right(project_id, page) {
	$.ajax({
		type: "POST",
		url: '/ajax/get_project_table_right',
		data: { "project_id": project_id, page: page },
		success: function (html1) {

			$('#card-user-modal_right').append(html1['content'])
