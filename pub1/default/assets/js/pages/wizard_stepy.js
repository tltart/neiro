...
$(function() {
    ...
    $.fn.stepy.defaults.backLabel = '<i class="fa fa-long-arrow-left" aria-hidden="true"></i> Назад';
    $.fn.stepy.defaults.nextLabel = 'Далее <i class="icon-arrow-right14 position-right"></i>';
