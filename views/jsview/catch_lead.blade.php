...
e.innerHTML=`<link href="{{env('API_DOMAIN')}}/cdn/v1/catch_lead/css/style_popup.css" rel="stylesheet" type="text/css">
...
<div class="" style="width: 100%;height: 100%;">
    ...
    <iframe id="neiros__lead_catcher" src="{{env('API_DOMAIN')}}/api/route_widget/catch_lead/`+divise+`/`+neiros_visit+`/`+CBU_GLOBAL.config.widget.key+`?promo=`+sbjs.get.promo.code+`&time=`+neiros_time+`&neiros_url_vst=`+neiros_url_vst+`&neiros_href_click=`+neiros_href_click+`&my_metrika_id=`+NEIROS_METRIKA_ID+`&session_id=`+UNIQ_NEIROS_ID+`&current_url=`+current_url_page+`"></iframe>
...
mass = [];
        mass.forEach.call( document.querySelectorAll('.neiros__open-lead-catch'), function(el) { el.addEventListener('click', function() {
