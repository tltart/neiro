<div id="ClientInfoModalAdd" class="modal fade ClientInfoModal lids-neiros">
    <form id="add_ajax_project">
        @csrf
        <input type="hidden" class="form-control" name="form_action" value="addnewlead">
            ...
            <div class="modal-content" style="height: 100vh">
                    ...
                    <div class="col-sm-5 col-xs-12">
                        ...
                        <div class="user-block col-xs-12">
                            <div class="col-xs-4 img-avatar">
                                <img src="/templatechat/images/pfotografy-none.jpg" width="70px">
                            </div>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="info">
                                    <div class="">
                                        ...
                                        <div class="form-group col-xs-12" style="padding-left:0px; padding-right:0px;">
                                            <label for="city">Сумма сделки</label>
                                            <input type="text" class=" lid-input-modal" name="summ"
                                                   placeholder="Сумма сделки" value="">
                                        </div>
                                        @php
                                            $canals=\App\Models\WidgetCanal::where('site_id', 0)->where('id','!=',3)->orwhere('site_id', auth()->user()->site)->orwhere('show_all',1)->get()
                                        @endphp

                                        <div class="form-group col-xs-12" style="padding-left:0px; padding-right:0px;">
                                            <label for="city">Источник</label>
                                           <select class="form-group" name="the_canals">
                ...
                <div class="form-group footer-button">
                    <div class="col-xs-12">
                        ...
                        <button type="button" class="btn btn-primary   w_safebuttoncreatelead">Сохранить</button>
