                    ...
                    <div class="col-md-12" style="padding-left:0px; padding-right:0px;">
                        ...
                        <table class="table table-bordered table-hover users-table" id="users-table">
                            ...
                            <tr class="no-open">
								...
								<th class="col-8">Статус</th>
								<th class="col-9">Источник</th>
                            </tr>
                            </thead>
...
"dom": '<"top">rt<"bottom"ilp><"clear">',
						...
						displayLength: 40,
                        ajax: '/alldata/data?user_group_id='+$('.user_group_id').val(),
				  ...
				  api.columns(3).search(date_serch).draw()
					  ...
					  api.columns().every(function() {
                        ...
                        columns: [
                        	...
                        	{ data: 'no_metrika', name: 'no_metrika' },
		...
		{ "orderable": false, "targets": 4 },
		{
        ...
        },
            {
                ...
                render: function(data, type, row, meta) {
                        ...
                        if(data==0){
                            data='<span class="leads__status-label" style="background-color: #efc455"><span class="block-selectable">Новая</span></span>';
                        }
                    if(data==1){
                        data='<span class="leads__status-label" style="background-color: null"><span class="block-selectable">Повторная</span></span>';
                    }
                    if(data==2){
                        data='<span class="leads__status-label" style="background-color: #45e31e"><span class="block-selectable">Целевая</span></span>';
                    }
                    return data;
                }
            },
...
tht=$(this);
		$.ajax({
			...
			success: function (html1) {
				...
				if(html1==1){
                    tht.html('Заблокирован');
					mynotif( 'Успешно!','Клиент забанен','info')
				}else{
                    tht.html('Заблокировать?')
