...
<tr>
    <td class="wrap-td-content-title" style="margin: 0;padding: 30px 0;font-family: 'Raleway', sans-serif;font-size: 18px;color: #24385b;font-style: normal;letter-spacing: normal;text-align: center;font-weight: normal;line-height: normal;-mso-line-height-rule: exactly;">
        Вы успешно прошли регистрацию в системе Neiros!
...
<tr>
    <td class="wrap-td-content-text" style="margin: 0;padding: 0;text-align: left;font-family: 'Raleway', sans-serif;font-size: 16px;color: #222222;font-style: normal;letter-spacing: normal;font-weight: normal;line-height: normal;-mso-line-height-rule: exactly; background: #f2f2f2;  border-radius: 5px; display:block; padding-left:30px; padding-bottom:15px; padding-top:15px; font-weight: bold;">
        <p class="wrap-td-content-text-p" style="margin-block-start: 0px;margin-block-end: 10px;">ID клиента:
            {{$my_company_id}}</p>
        <p class="wrap-td-content-text-p" style="margin-block-start: 0px;margin-block-end: 10px;">Логин:
            <span style="color:#5998c8;">{{$email}}</span></p>

        <p class="wrap-td-content-text-p" style="margin-block-start: 0px;margin-block-end: 0px;">Пароль: {{$password}}</p>
...
<tr>
    ...
    <p class="wrap-td-content-text-p" style="margin-block-start: 0px;margin-block-end: 35px;">После установки кода Вам 14 дней абсолютно бесплатно будет доступен полный функционал сервиса, а
        так же 100 минут для звонков и 30 смс для отчетов. После Вы сможете продлить подписку или остаться на бесплатной
        версии и пользоваться любым виджетом.</p>
