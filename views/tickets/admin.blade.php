...
<table class="table table-bordered">
    ...
    @foreach($tickets as $item)
        <tr>
            ...
            <td @if($item->agent_no_read==1) style="font-weight: bold" @endif>{{optional($item->user)->name}}</td>
            <td @if($item->agent_no_read==1) style="font-weight: bold" @endif>{{optional($item->agent)->name}}</td>
            <td @if($item->agent_no_read==1) style="font-weight: bold" @endif>{{optional($item->category)->name}}</td>
