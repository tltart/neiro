                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            @foreach($phones as $phone)
                                                <tr id="ids{{$phone->id}}">
                                                    ...
                                                    <td><a href="#"  onclick="delete_number({{$phone->input}},{{$phone->id}})"><i
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($input_calls as $cal)
                                        <tr>
                                            ...
                                            <td><audio controls>
                                                    <source src="http://env('ASTER_IP')/records/{{date('Y',strtotime($cal->calldate))}}/{{date('m',strtotime($cal->calldate))}}/{{date('d',strtotime($cal->calldate))}}/{{$cal->record_file}}.mp3" type="audio/mp3" >

                                                    http://env('ASTER_IP')/records/{{date('Y',strtotime($cal->calldate))}}/{{date('m',strtotime($cal->calldate))}}/{{date('d',strtotime($cal->calldate))}}/{{$cal->record_file}}.mp3
                                                </audio></td>
                                            <td>
