...
<div id="myModal_sett_10" class="modal fade ClientInfoModal lids-neiros integration___modal WidgetModal">
    ...
    <div class="col-xs-12">
     ...
     <div class="col-xs-12"><label class="add-number-new-checkbox label-dir">Уведомления о сделках:
                                    
                                     <input type="checkbox" name="bot_notify_lead" class="dircheck" id="bot_notify_lead"     value="1" @if($widget_vk->bot_notify_lead==1)checked @endif>
                                                            <span class="checkmark"></span>
                                                        </label>
                        </div>


     <div class="col-xs-12"><label class="add-number-new-checkbox label-dir">Уведомления о новых сообщениях чата:
                                    
                                     <input type="checkbox" name="bot_notify_mess" class="dircheck" id="bot_notify_lead"     value="1" @if($widget_vk->bot_notify_lead==1)checked @endif>
                                                            <span class="checkmark"></span>
                                                        </label>
                        </div>
