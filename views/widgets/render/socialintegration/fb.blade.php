<div class="col-md-3 integration-item">
    <div class="single-cases-card">
        <div class="card-image"><a data-toggle="modal" data-target="#myModal_sett_9"><img alt=""
                                                                                          src="/global_assets/images/integration/fb-messenger.jpg"
                                                                                          draggable="false"
        ...
        <div class="modal-content" style="height: 100vh">
            ...
            <div class="modal-body">
                <div class="name-block-fixed name-block-fixed-integration">
                    <div class="col-xs-12">
                        <div class="h1-modal pos-left"><img src="/images/fb-messenger-integration.jpg"><span></span>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 block-descr">
                        ...
                        <div class="col-sm-6">
                            <div class="paragraph">Facebook – крупнейшая социальная сеть в мире и одноименная компания
                                (Facebook Inc.), владеющая ею. Была основана 4 февраля 2004 года Марком Цукербергом и
                                его соседями по комнате во время обучения в Гарвардском университете — Эдуардо
                                Саверином, Дастином Московицем и Крисом Хьюзом.
                            </div>
                            {!! $status_checkbox_metrika !!}
                        ...
                        <div class="col-md-12">
                            ...
                            @if(count($fb_pages)>0)
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="start_message" id="start_message"
                                               value="{{$widget_vk->start_message}}" required>

                                    </div>

                                </div>
                                <div class="row">Выберите страницы для подключения к чат боту</div>
                                @foreach($fb_pages->where('site_id',auth()->user()->site) as $item)
                                    <div class="form-group row">
                                        <input type="checkbox" name="pages[]" value="{{$item->fb_id}}" @if($item->status==1) checked @endif>{{$item->name}} @if($item->token!='')<i class="fa fa-check"></i>@endif
                            ...
                            <div class="form-group footer-button">
                                <div class="col-xs-12">
                                    ...
                                    <button type="button" class="btn btn-primary  w_safebutton ">Сохранить
                                    </button>
