...
{{----}}
            <div class="form-group row">
                <label class="col-lg-3 control-label">Код поля NeirosVisit:</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="field_neirod_visit" id="field_neirod_visit"
                           value="{{$widgets_bitrix24->field_neirod_visit}}" >

                </div>

            </div>
            <div class="form-group row">
                <label class="col-lg-3 control-label">Код поля Источник:</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="field_source" id="field_sourse"
                           value="{{$widgets_bitrix24->field_source}}" >
