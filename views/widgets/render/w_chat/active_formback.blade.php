            ...
            <form id="wchat" name="wchat">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-30">
                            <div class="row">
                                <label class="col-lg-12 control-label">Темы обращений через запятую:</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control input-tags" name="formback_tema" id="formback_tema"
                        ...
                        <div class="col-md-12 mt-30 row mb-20">
                            <label class="col-lg-12 control-label">Текст после отправки формы:</label>
                            <div class="col-md-12">

                                <input type="text" class="form-control" name="callback_end_text"
                                       id="callback_end_text"
                    ...
                    <h4>Настройка видимости полей формы</h4>
                    <div class="form-group col-md-6">
                        <div class="row">
                            <label class="col-lg-8 control-label">Видимость поля Имени :</label>
                            <div class="col-lg-4">
                    ...
                    <div class="form-group col-md-6">
                        <div class="row">
                            <label class="col-lg-8 control-label">Обязательное поля Имени :</label>
                            <div class="col-lg-4">
                                <div class="checkbox checkbox-switchery">
                                    <label>
                    ...
                    <div class="form-group col-md-6">
                        <div class="row">
                            <label class="col-lg-8 control-label">Видимость поля E-mail :</label>
                            <div class="col-lg-4">
                                <div class="checkbox checkbox-switchery">
                                    <label>
                    ...
                    <div class="form-group col-md-6">
                        <div class="row">
                            <label class="col-lg-8 control-label">Обязательное поля E-mail :</label>
                            <div class="col-lg-4">
                                <div class="checkbox checkbox-switchery">
                                    <label>
                    ...
                    <div class="form-group col-md-6">
                        <div class="row">
                            <label class="col-lg-8 control-label">Видимость поля Темы :</label>
                            <div class="col-lg-4">
                                <div class="checkbox checkbox-switchery">
                                    <label>
                    ...
                    <div class="form-group col-md-6">
                        <div class="row">
                            <label class="col-lg-8 control-label">Обязательное поля Темы :</label>
                            <div class="col-lg-4">
                                <div class="checkbox checkbox-switchery">
                                    <label>
