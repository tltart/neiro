    ...
    <form class="form-horizontal" action="" method="post">
        ...
        <div class="form-group">
            <div class="col-lg-3">
                <label class=" control-label" style="width:100%">Авто закрытие сделок (часов):</label>
            </div>
            <div class="col-lg-2" style="    margin-top: -5px;">
                <input type="text" name="project_autoclose" id="project_autoclose"
                       value="{{$autoclose}}">
            </div>
        </div>
		...
		<div class="form-group">					
        <div class="col-lg-3">
            <label class=" control-label" style="width:100%">Время целевого звонка (сек):</label>
        </div>
        <div class="col-lg-2" style="    margin-top: -5px;">
            <input type="text" name="time_call_lead" id="time_call_lead"
                   value="{{$sec}}">
        </div>
        </div>
        <div class="form-group">
            <div class="col-lg-3">
                <label class=" control-label" style="width:100%"> Не закреплять номер, если время сессии меньше (секунд):</label>
            </div>
            <div class="col-lg-2" style="    margin-top: -5px;">
                <input type="text" name="call_time_session" id="call_time_session"
                       value="{{$call_time_session}}">
            </div>
        </div>
