...
">				<span class="allrep2">
                <span class="btn btn-default analytics-report-btn    "
                      onclick="window.location.href='/reports'"><span class="select_my_report "
                    >Основной</span> </span>
                        <span class="btn btn-default analytics-report-btn    "
...
&&$dashbord_setting['date_end']==$dashbord_setting['date_this']) active @endif"
                    data-start="{{$dashbord_setting['date_kvartal']}}"
...
&&$dashbord_setting['date_end']==$dashbord_setting['date_this']) active @endif"
                    data-start="{{$dashbord_setting['date_year']}}"
