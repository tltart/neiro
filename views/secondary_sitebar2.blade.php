<!-- Secondary sidebar -->
<div id="secondary-sitebar-block" class="sidebar sidebar-secondary sidebar-default" style="background: white" >
    <div class="sidebar-content">
        ...
        <div id="close-secondary-sitebar" style="
    position: fixed;
    background: #000;
    top: 154px;
    width: 20px;
...
--}}
 @if(Auth::user()->super_admin==1)
  ...
  @endif                      
                    ...
                    <li><a href="#" class="item-widget1" data-name="Смс отчеты" data-id="setting_smsreports"><i class="fa fa-envelope-open-o" aria-hidden="true"></i> <span>SMS отчеты</span></a></li>
                
              <li><a href="#"  class="item-widget1" data-name="Партнерская программа" data-id="setting_partners"><i class="fa fa-black-tie" aria-hidden="true"></i> <span style="
    display: block;
    float: left;
    margin-top: -3px;
    line-height: 1.2;
...
<?php */?>                           <li><a   data-type-menu="#basic-tab2"><i class="fa fa-list-ol" aria-hidden="true"></i> <span>Номера</span></a></li>           
                      ...
                      <li><a   data-type-menu="#basic-tab4"><i class="fa fa-volume-up" aria-hidden="true"></i> <span>Журнал звонков</span></a></li>
