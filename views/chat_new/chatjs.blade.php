...
$url = $_SERVER['HTTP_HOST'];
 ...
 $ARRAY_CHAT = file_get_contents('https://cloud.neiros.ru/get_setting?subtip=26&json=1&my_company_id='.$wts->sites_id);
$OPERATOR_STATUS_ALL = 0;
$ARRAY_CHAT_COUNT_RAND = 1;	
 $chat_message = 'Здравствуйте! Чем могу Вам помочь?';
 if($ARRAY_CHAT != 'error chat off'){
 $OPERATOR_URL = 'https://cloud.neiros.ru/cdn/v1/chatv2/images/agent.png';
...
for (var i = 0; i < ARRAU_CHAT.operator_urls.length; i++){
    ...
    createCookie('neiros_operator_id',obj.operator_id,1);
     ...
     document.querySelector("#neiros__chat_start img").setAttribute('src', ' https://cloud.neiros.ru/cdn/v1/chatv2/images/agent.png');
...
for (var i = 0; i < ARRAU_CHAT.mess_rules.length; i++){
    var obj = ARRAU_CHAT.mess_rules[i];
       if(obj.message !== null){
...
function addIframe_calback(type,stat){
        ...
        list.innerHTML = '<div class="neiros__closet-icon-modal '+type_new+'">'+content_new+'</div><iframe id="neiros__chat_iframe" class="active"  src="{{env('API_DOMAIN')}}/xcallback/'+divise+'/'+neiros_visit+'/'+CBU_GLOBAL.config.widget.key+'?promo='+sbjs.get.promo.code+'&type='+type+'&'+divise+'&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe><div class="neiros__copiright_new2">Виджет заряжен Neuron</div>'
...
list.innerHTML = '<div class="neiros__closet-icon-modal"><img  src="images/icons/closet-icon-modal.PNG" alt=""></div><iframe onload="hiddenPreloader(this)"  '+iframe_active+' id="neiros__chat_iframe" src="https://cloud.neiros.ru/chat/'+divise+'/'+neiros_visit+'/'+CBU_GLOBAL.config.widget.key+'?promo='+sbjs.get.promo.code+'&neirosphone='+DINAMICPHONE+'&test=1&chat_message='+neiros_chat_message+'&operator_id='+neiros_operator_id_n+'&status_operator='+OPERATOR_STATUS_ALL+'&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe>'+neiros_class+'<div class="neiros__copiright_new2">Виджет заряжен Neiros</div>'
...
neiros_chat_message = getCookie('neiros_chat_message');
neiros_operator_id_n = getCookie('neiros_operator_id');
list.innerHTML = '<div class="neiros__closet-icon-modal '+type_new+'">'+content_new+'</div><iframe onload="hiddenPreloader(this)"  '+iframe_active+' id="neiros__chat_iframe" src="https://cloud.neiros.ru/chat/'+divise+'/'+neiros_visit+'/'+CBU_GLOBAL.config.widget.key+'?promo='+sbjs.get.promo.code+'&type='+type+'&neirosphone='+DINAMICPHONE+'&test=1&chat_message='+neiros_chat_message+'&operator_id='+neiros_operator_id_n+'&status_operator='+OPERATOR_STATUS_ALL+'&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe>'+neiros_class+'<div class="neiros__copiright_new2">Виджет заряжен Neiros</div>'
...
neiros_chat_message = getCookie('neiros_chat_message');
neiros_operator_id_n = getCookie('neiros_operator_id');
list.innerHTML = '<div class="neiros__closet-icon-modal"><img  src="images/icons/closet-icon-modal.PNG" alt=""></div><iframe id="neiros__chat_iframe" src="https://cloud.neiros.ru/chat/'+divise+'/'+neiros_visit+'/'+CBU_GLOBAL.config.widget.key+'?promo='+sbjs.get.promo.code+'&neirosphone='+DINAMICPHONE+'&test=1&chat_message='+neiros_chat_message+'&operator_id='+neiros_operator_id_n+'&status_operator='+OPERATOR_STATUS_ALL+'&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe>';*/
}
...
neiros_operator_id_n = getCookie('neiros_operator_id');
list = document.querySelector("#neiros__chat_before_iframe");
list.innerHTML = '<div class="neiros__closet-icon-modal"></div><iframe id="neiros__chat_iframe" src="https://cloud.neiros.ru/chat/'+divise+'/'+neiros_visit+'/'+CBU_GLOBAL.config.widget.key+'?promo='+sbjs.get.promo.code+'&neirosphone='+DINAMICPHONE+'&test=1&chat_message='+neiros_chat_message+'&operator_id='+neiros_operator_id_n+'&status_operator='+OPERATOR_STATUS_ALL+'&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe>'
...
list = document.querySelector("#neiros__chat_before_iframe");
list.innerHTML = '<div class="neiros__closet-icon-modal '+type_new+'">'+content_new+'</div><iframe onload="hiddenPreloader(this)" '+iframe_active+' id="neiros__chat_iframe"  src="https://cloud.neiros.ru/chat/'+divise+'/'+neiros_visit+'/'+CBU_GLOBAL.config.widget.key+'?type='+type+'&promo='+sbjs.get.promo.code+'&'+divise+'=1&neirosphone='+DINAMICPHONE+'&test=1&chat_message='+neiros_chat_message+'&operator_id='+neiros_operator_id_n+'&status_operator='+OPERATOR_STATUS_ALL+'&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe>'+neiros_class+'<div class="neiros__copiright_new2">Виджет заряжен Neiros</div>'
...
list = document.querySelector("#neiros__chat_before_iframe");
list.innerHTML = '<div class="neiros__closet-icon-modal"><img  src="https://cloud.neiros.ru/cdn/v1/chatv2/images/icons/closet-icon-modal.PNG" alt=""></div><iframe id="neiros__chat_iframe" src="chat.php?'+divise+'=1&my_metrika_id='+NEIROS_METRIKA_ID+'"  ></iframe>';*/
}
document.addEventListener("DOMContentLoaded", ready);
ready();