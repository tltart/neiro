...
<head>
    <meta charset="utf-8">
    <title>Чат</title>
    <link href="{{env('API_DOMAIN')}}/cdn/v1/callback/css/timepicki.css" rel="stylesheet" type="text/css">
    <link href="{{env('API_DOMAIN')}}/cdn/v1/callback/css/datepicker.min.css" rel="stylesheet" type="text/css">
    <link href="{{env('API_DOMAIN')}}/cdn/v1/callback/css/select2.css" rel="stylesheet" type="text/css">
    <link href="{{env('API_DOMAIN')}}/cdn/v1/callback/css/style.css" rel="stylesheet" type="text/css">
    <link href="{{env('API_DOMAIN')}}/cdn/v1/callback/css/style_call.css" rel="stylesheet" type="text/css">
    <script src="{{env('API_DOMAIN')}}/cdn/v1/callback/js/jquery-2.1.1.js"></script>
    <script src="{{env('API_DOMAIN')}}/cdn/v1/callback/js/jquery.inputmask.js"></script>
    <script src="{{env('API_DOMAIN')}}/cdn/v1/callback/js/jquery.ddslick.min.js"></script>
    <script src="{{env('API_DOMAIN')}}/cdn/v1/callback/js/datepicker.min.js"></script>
    <script src="{{env('API_DOMAIN')}}/cdn/v1/callback/js/timepicki.js"></script>
    <script src="{{env('API_DOMAIN')}}/cdn/v1/callback/js/select2.js"></script>
</head>
...
<div id="neiros__panel_widget" class="<? echo $mobile.$desc_animation?>" >
    ...
    <div id="neiros__tab_callback_desc" <?php /*?>class="no-copiright"<?php */?>>
        ...
        <div class="neiros__closet-icon-modal"><img  src="{{env('API_DOMAIN')}}/cdn/v1/callback/images/icons/closet-icon-modal-callback.PNG" alt=""></div>
...
@else
    ...
    @endif
            ...
            datatosend = {
                ...
                site:'{{$site}}',
				my_metrika_id:'{{$my_metrika_id}}', CURRENT_URL: '{{$CURRENT_URL}}',
    ...
    var ddData = [
        {
            ...
            selected: true,
            description: "",
            imageSrc: "{{env('API_DOMAIN')}}/cdn/v1/callback/images/country/russia.png"
        },
        {
            text: '',
            selected: false,
            value: 'US',
            description: "",
            imageSrc: "{{env('API_DOMAIN')}}/cdn/v1/callback/images/country/united-kingdom.png"
        }
    ];
    var ddData2 = [
        {
