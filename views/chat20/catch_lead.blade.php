...
?>
<div id="neiros_pop-ups" data-id="<?=$off?>">
...
$('#neiros__tab_callback_day').change( function () {
    ...
    if(sel=={{$dayt[$i]['day']}}) {
        ...
        $('#neiros__tab_callback_time').html('');
...
@if($off==1)
$('.neiros_all_block').css('display', 'none'); $('#neiros__pop_ups_position_2').css('display','block');$("#neiros__pop_ups_position_2 .neiros__callback_input").focus();
$("#neiros__pop_ups_position_2 .neiros__callback_input").focus();
@else
$('.neiros_all_block').css('display', 'none');
$('#neiros__pop_ups_position_3').css('display','block');
