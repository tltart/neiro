        ...
        <div class="panel-heading">
            ...
            <div class="row">
                <input type="hidden" id="hidden_start11" value="{{$stat_start_date}}">
                <input type="hidden" id="hidden_end11" value="{{$stat_end_date}}">
                <div class="col-md-2">Сумма <span id="mysumm11">{{$total_summ}}</span> р</div>
                ...
                @if($user->super_admin==1)
                    ...
                    <input type="hidden" id="clients11" value="{{$user->my_company_id}}">


                @endif
                <div class="col-md-3">
                    <button type="button" onclick="generate_p11()">Сформировать</button>
                </div>
            </div>
        </div>
...
@endif
    ...
    <script>    // Daterange picker
        ...
        function generate_p11() {
            $('#mytable11').html('Загрузка');
            clients = $('#clients11').val();
            hidden_start = $('#hidden_start11').val();
            hidden_end = $('#hidden_end11').val();
            datatosend = {
                clients: clients,
            ...
            $.ajax({
                ...
                success: function (html1) {
                    res = JSON.parse(html1);
                     $('#mytable11').html(res['mytable']);
                     $('#mysumm11').html(res['mysumm']);
        ...
        $('.daterange-ranges').daterangepicker(
            ...
            function (start, end) {
                ...
                $('#hidden_end11').val(end.format('DD-MM-Y'));
                $('#hidden_start11').val(start.format('DD-MM-Y'));
