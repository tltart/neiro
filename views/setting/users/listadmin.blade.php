    ...
    <div class="panel panel-white">
        ...
        <table class="table tasks-list table-lg">
            ...
            @foreach($stages as $client)
                ...
                <td>{{optional($client->getcompany)->name}}</td>
                <td id="balans" class="click_balans" data-id="{{$client->id}}" data-name_client="{{$client->name}}">{{optional($client->getcompany)->ballans}}</td>
