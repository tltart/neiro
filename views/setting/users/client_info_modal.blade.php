...
<input type="file" name="image">-->
           <? $OPERATOR_URL = 'https://cloud.neiros.ru/global_assets/images/icon/user/i-user.png';
			if(optional($user)->image != null){
										
										$OPERATOR_URL = 'https://disk.neiros.ru/user_upload/'.optional($user)->image;
			}
                             ...
                             <img class="i-img-hover" data-alt-src="https://cloud.neiros.ru/global_assets/images/icon/user/i-user-hover.png"
                                    ...
                                    <img class="i-icon-prew" src="{{$OPERATOR_URL}}" alt="">
                                    ...
                                    <button type="button" id="i-ava-save" class="btn btn-primary s-ava-save  i-ava-btn w_safebutton_new">Сохранить
                                    </button>
                    ...
                    <div class="col-xs-9 user-description">
                        ...
                        <div class="form-group col-xs-12" style="padding-left:0px; padding-right:0px;">
                            ...
                            <input type="password"  data-input-cont-id="21109" data-old-val=""  class="form-control" id="email" data-input-name="projects_email" placeholder="Пароль"   name="password" autocomplete="off" ><i class="fa fa-pencil" aria-hidden="true"></i><i class="fa fa-floppy-o" aria-hidden="true"></i>
                        </div>
                ...
                <div class="user-block col-xs-12 user-block-security">
                    ...
                    <div class="form-group col-sm-5 col-xs-12 select-conainer-icon-multi select-conainer-icon-roll" style="padding-left:10px; padding-right:0px;">
                        ...
                        <select data-placeholder="+ Добавить Роль" multiple="multiple" class="select-icons select-roll-user form-group" style="width:80%" id="roll" name="role[]" autocomplete="off">
                           ...
                           <option value="0" @if(in_array(0,$usergroups_role)) selected @endif>Администратор</option>
                            <option value="1" @if(in_array(1,$usergroups_role)) selected @endif>Менеджер</option>
                            <option value="2"@if(in_array(2,$usergroups_role)) selected @endif>Оператор</option>
                        </select>
                    </div>
                    @if(isset($user->id))
<input type="hidden" name="id" value="{{optional($user)->id}}">@else
                    ...
                    <div class="form-group col-sm-5 col-xs-12 select-conainer-icon-multi select-conainer-icon-group2" style="padding-left:0px; padding-right:0px;">
                        ...
                        <select data-placeholder="+ Добавить Группу" multiple="multiple" class="select-icons select-group2-user form-group" style="width:80%" id="group" name="users_group_id[]" autocomplete="off">
